...
export function PowerSection() {
  ...
  const items: CardItem[] = [
    { Icon: BatteryCharging, h: t("Автономный дизель-генератор", "Автономды дизель-генератор"), p: t("Мощность 380 кВт со встроенным баком — до 8 часов бесперебойной работы под нагрузкой.", "Кірістірілген багы бар 380 кВт қуат — жүктеме кезінде 8 сағатқа дейін үздіксіз жұмыс.") },
