...
function Advantages() {
  ...
  const items = [
    ...
    },
    {
      ...
      p: t(
        "24 серверных шкафа и прецизионным охлаждением (InRow по 35 кВт).",
        "Прецизиялық салқындатумен (InRow 35 кВт бойынша) 24 серверлік шкаф."
      ),
    },
    {
      Icon: Flame,
    ...
    {
      Icon: Fingerprint,
      h: t("Надежная система безопасности", "Сенімді қауіпсіздік жүйесі"),
      p: t(
        "Объект находится под постоянной физической охраной. Доступ на территорию осуществляется через современную систему контроля и управления доступом (СКУД), а также ведется круглосуточное видеонаблюдение.",
        "Нысан тұрақты физикалық күзетпен қамтамасыз етілген. Аумаққа кіру заманауи рұқсатты бақылау және басқару жүйесі (РББЖ / СКУД) арқылы жүзеге асырылады, сондай-ақ тәулік бойы бейнебақылау жүргізіледі."
      ),
    },
    {
      Icon: Thermometer,
            ...
            <div className="calc-grid">
              <div className="calc-form">
                ...
                <ColoCounterRow
                  ...
                  hintTip={t(
                    "Нужен, если сервер по размеру больше 1 unit. Розетка электропитания не предоставляется.",
                    "Егер сервер 1 unit-тен үлкен болған жағдайда керек болады. Электр розеткасы берілмейді."
                  )}
                  unit={t("шт", "дана")}
                  step={1}
                  min={0}
                ...
                <ColoCounterRow
                  ...
                  hintTip={t(
                    "Аренда дополнительной резервной розетки сети электропитания для резервного блока питания мощностью не более 500 Вт.",
                    "500 Вт-тан көп емес қуаттылықтағы резервтік блок қуат үшін қосымша электр розеткасын жалдау."
                  )}
                  unit={t("шт", "дана")}
                  step={1}
                  min={0}
                ...
                <ColoCounterRow
                  label={t("Дополнительный Ethernet-порт 1 Гбит/с", "Қосымша Ethernet-порт 1 Гбит/с")}
                  hint={t("Интернет до 100 Mb/s.", "100 Mb/s дейінгі интернет.")}
                  unit={t("шт", "дана")}
                  step={1}
                  min={0}
