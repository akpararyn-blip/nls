...
const stats = [
  ...
  { value: "15 000+", label: "юридических лиц" },
  { value: "1 000+", label: "специалистов" },
  { value: "18 000+ км", label: "собственной сети" },
];
...
const benefits = [
  ...
  },
  {
    ...
    text: "Дата-центр в Алматы Tier III.",
  },
  {
  ...
  },
  {
    ...
    text: "Присутствие в большинстве БЦ Алматы, Алматинской области, Астаны и Шымкента.",
  },
];
      ...
      <section className="about-hero">
        <div className="container">
          ...
          <p className="about-hero-text">
            Более 18 лет мы строим телеком и IT-инфраструктуру для бизнеса в Казахстане. Более 1 000
            специалистов, собственный дата-центр и магистральная сеть — всё, чтобы ваш бизнес работал без
            перебоев.
          </p>
