      ...
      <section className="about-hero">
        <div className="container">
          ...
          <p className="about-hero-text">
            14 лет мы строим телеком- и IT-инфраструктуру для бизнеса в Казахстане. Более 300 специалистов,
            собственные дата-центры и магистральная сеть — всё, чтобы ваш бизнес работал без перебоев.
          </p>
