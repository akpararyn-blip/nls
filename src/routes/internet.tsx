    ...
    <section className="dc-tiles-section">
      <div className="container">
        <div className="section-title">
          ...
          <p>Размещайте инфраструктуру в собственном дата-центре NLS Kazakhstan.</p>
        </div>
...
function Trust() {
  const items = [
    ...
    },
    {
      ...
      p: "От 10 Мбит/с для малого офиса до 10 000 Мбит/с для крупных корпораций. Растём вместе с вами.",
    },
    {
      h: "Техподдержка 24/7",
