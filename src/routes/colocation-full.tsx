    ...
    <section className="hero hero--no-image-mobile">
      <div className="container">
        <div className="hero-content">
          ...
          <h1>
            {t("Аренда серверной стойки в ЦОД Tier III", "Tier III дата-орталығында серверлік шкафты жалға алу")}{" "}
    ...
    <section className="trust-section">
      <div className="container">
        <div className="section-title">
          ...
          <p>{t("Решение «под ключ» для размещения большого парка оборудования.", "Үлкен жабдық паркін орналастыру үшін дайын күйінде шешім.")}</p>
        </div>
...
function Advantages() {
  const t = useT();
  const items = [
    { Icon: ShieldCheck, h: t("Отказоустойчивость Tier III", "Tier III істен шықпауы"), p: t("Многоуровневая архитектура 2N, два независимых энерговвода, ИБП и дизель-генераторы с автозапуском.", "Көп деңгейлі 2N сәулеті, екі тәуелсіз энергия кірісі, ҮҚК және автоматты іске қосумен дизельді генераторлар.") },
    { Icon: Snowflake, h: t("Изолированный холодный коридор", "Оқшауланған суық дәліз"), p: t("24 серверных шкафа и прецизионным охлаждением (InRow по 35 кВт).", "Прецизиялық салқындатумен (InRow 35 кВт бойынша) 24 серверлік шкаф.") },
    ...
    { Icon: Fingerprint, h: t("Надежная система безопасности", "Сенімді қауіпсіздік жүйесі"), p: t("Объект находится под постоянной физической охраной. Доступ на территорию осуществляется через современную систему контроля и управления доступом (СКУД), а также ведется круглосуточное видеонаблюдение.", "Нысан физикалық күзетпен қамтамасыз етілген. Аумаққа кіру заманауи рұқсатты бақылау және басқару жүйесі (РББЖ / СКУД) арқылы жүзеге асырылады, сондай-ақ тәулік бойы бейнебақылау жүргізіледі.") },
