...
function Advantages() {
  const t = useT();
  const items = [
    { Icon: ShieldCheck, h: t("Отказоустойчивость Tier III", "Tier III істен шықпауы"), p: t("Многоуровневая архитектура N+1, два независимых энерговвода, ИБП и дизель-генераторы с автозапуском.", "Көп деңгейлі N+1 сәулеті, екі тәуелсіз энергия кірісі, ҮҚК және автоматты іске қосумен дизельді генераторлар.") },
